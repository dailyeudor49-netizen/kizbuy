      ...
      <footer className="bg-white text-gray-400 py-12 text-center text-xs border-t border-gray-200 pb-40">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-6 font-bold uppercase text-[10px] tracking-widest text-gray-500">
            <span className="cursor-pointer hover:text-black">Adatvédelmi Irányelvek</span>
            <span className="cursor-pointer hover:text-black">Értékesítési Feltételek</span>
            <span className="cursor-pointer hover:text-black">Kapcsolat</span>
          </div>
          <p className="opacity-60 max-w-xs mx-auto leading-relaxed">
             &copy; 2025 LithiumPro Tools.<br/>Minden jog fenntartva.
          </p>
        </div>
      </footer>
