    ...
    if (typeof window !== 'undefined' && !alreadyTracked) {
      ...
      script.onload = () => {
        ...
        window.gtag('event', 'conversion', {
          'send_to': 'AW-17930736121/8BBeCNf1sPsbEPmjheZC',
          'value': ecValue,
          'currency': 'CZK',
      ...
      <div className="ty-box" style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            <div style={{ width: '32px', height: '32px', background: '#16a34a', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '0.75rem' }}>Kč</div>
            <div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '0.25rem' }}>Potřebujete pomoc nebo chcete požádat o vrácení?</div>
