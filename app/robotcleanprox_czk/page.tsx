...
export default function RobotCleanProXPage() {
  ...
  return (
    <>
      ...
      <img src="https://offers.supertrendaffiliateprogram.com/forms/api/ck/?o=597&uid=01981ccf-4474-7c39-97eb-9407221996c2&lp=597" style={{width:'1px',height:'1px',display:'none'}} alt="" />
      <div className="min-h-screen bg-gray-50 text-gray-900 pb-24 overflow-x-hidden">
        ...
        <main>
          ...
          <div className="bg-gray-900 text-white text-center py-3 text-sm font-medium tracking-wide">
            🚚 Doprava Zdarma po celé České republice jen dnes
          </div>
          ...
          <div className="bg-red-600 text-white text-center py-8 px-4">
            <div className="max-w-2xl mx-auto">
              <h3 className="text-2xl md:text-3xl font-black mb-2 uppercase">Nenechte si ujít nabídku -50%</h3>
              <p className="font-medium mb-6 text-red-100">Více než 1 500 objednávek dnes. Nabídka brzy končí.</p>
              <button
                onClick={scrollToForm}
