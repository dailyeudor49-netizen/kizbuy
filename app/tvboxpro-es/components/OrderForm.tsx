      ...
      return (
          <section id="order-form" className="py-16 px-4 bg-green-50 min-h-[50vh] flex items-center justify-center">
              <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-2xl text-center border-4 border-green-500">
                  ...
                  <h2 className="text-3xl font-black text-gray-900 mb-4">¡GRACIAS, {formState.name}!</h2>
                  <p className="text-xl text-gray-700 mb-6">Tu pedido ha sido confirmado.</p>
                  <p className="text-gray-600">Uno de nuestros colaboradores se pondrá en contacto contigo pronto al número <span className="font-bold">{formState.phone}</span> para confirmar la entrega.</p>
                  <div className="mt-6 bg-yellow-100 p-4 rounded-lg border border-yellow-300">
                    <p className="font-bold text-gray-800 uppercase text-sm mb-1">Importe a pagar al mensajero:</p>
    ...
    <section id="order-form" className="py-12 px-4 bg-gray-200">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden border-2 border-gray-300">
        ...
        <div className="bg-red-600 text-white p-6 text-center">
          <h2 className="text-3xl font-black uppercase mb-2">FORMULARIO DE PEDIDO</h2>
          <p className="text-lg font-medium">Rellena abajo para asegurar la promoción</p>
          ...
          <div className="flex items-center justify-center gap-2 mt-4 bg-red-700 py-2 rounded-lg border border-red-500">
            ...
            <span className="font-bold text-xl">La oferta expira en: {formatTime(timeLeft)}</span>
          </div>
        </div>
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="bg-yellow-50 border-2 border-yellow-400 p-4 rounded-lg mb-8 shadow-sm">
            <h3 className="font-bold text-gray-800 text-lg mb-2 border-b border-yellow-200 pb-2">Resumen del pedido:</h3>
            <div className="flex justify-between items-center mb-1 text-lg">
             ...
             <div className="flex justify-between items-center text-gray-700 text-sm mb-2">
              <span className="flex items-center gap-1"><Truck size={16}/> Envío rápido (24/48h)</span>
            ...
            <div className="flex justify-between items-center mt-3 pt-3 border-t-2 border-yellow-200 text-2xl font-black text-red-600">
              <span>TOTAL (Pago contra reembolso):</span>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-gray-700 font-bold mb-2 text-lg">Nombre y Apellidos <span className="text-red-500">*</span></label>
              <input
                type="text"
                name="name"
                required
            ...
            <div>
              <label className="block text-gray-700 font-bold mb-2 text-lg">Número de teléfono <span className="text-red-500">*</span></label>
              <input
                type="tel"
                name="phone"
                required
                ...
                onChange={handleChange}
              />
              <p className="text-sm text-gray-500 mt-1 font-medium bg-blue-50 p-2 rounded text-blue-800">ℹ️ Importante: El mensajero llamará a este número antes de la entrega.</p>
            </div>

            <div>
              <label className="block text-gray-700 font-bold mb-2 text-lg">Dirección completa de envío <span className="text-red-500">*</span></label>
              <textarea
                name="address"
                required
                placeholder="Ciudad, Calle, Número, Piso, Puerta (o punto de recogida)"
                rows={3}
            ...
            <div className="bg-gray-100 p-4 rounded-lg flex items-center gap-3 text-sm text-gray-600 border border-gray-200">
               ...
               <span>Cero riesgo: pagas en efectivo/tarjeta solo cuando recibas el paquete.</span>
            </div>
            ...
            >
              ...
              <span className="block text-lg font-normal mt-2 text-green-100">Envío Rápido y Pago contra Reembolso</span>
            </button>
          </form>
        </div>
      </div>
