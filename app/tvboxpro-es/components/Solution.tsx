    ...
    <section className="py-12 bg-gray-50 px-4">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl md:text-5xl font-black text-center mb-4 text-gray-900 leading-tight uppercase">
          EL DISPOSITIVO <span className="text-red-600 bg-yellow-200 px-2">SOÑADO</span> PARA TU HOGAR
        </h2>
        <p className="text-center text-xl text-gray-600 mb-12 max-w-3xl mx-auto font-medium">
          Olvida todo lo que sabes sobre televisión. Así es como este box <strong>4K Ultra HD</strong> cambia tu vida nada más enchufarlo:
        </p>
        ...
        <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 bg-white p-6 rounded-2xl shadow-xl border-2 border-gray-100 transform hover:scale-[1.01] transition duration-300">
                ...
                <div className="w-full md:w-1/2 text-left">
                    ...
                    <p className="text-gray-600 text-lg mb-4 leading-relaxed">
                        Esto no es simplemente "ver la tele", es sumergirte en la película. Gracias al <strong>4K Ultra HD con HDR</strong>, los colores cobran vida y los detalles son increíbles. Netflix, YouTube y HBO Max arrancan al instante.
                    </p>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-8 bg-white p-6 rounded-2xl shadow-xl border-2 border-gray-100 transform hover:scale-[1.01] transition duration-300">
                ...
                <div className="w-full md:w-1/2 text-left">
                    ...
                    <p className="text-gray-600 text-lg mb-4 leading-relaxed">
                        Ves cada brizna de césped. Gracias al <strong>4K fluido a 60fps</strong>, los partidos de La Liga y Champions (DAZN, Movistar+) no se congelan, ni siquiera en los derbis. Tus amigos querrán ver los partidos solo en tu casa.
                    </p>
                    <ul className="space-y-2">
                        <li className="flex items-center gap-2 font-bold text-gray-800">
                        ...
                        <li className="flex items-center gap-2 font-bold text-gray-800">
                            <CheckCircle2 className="text-green-500 shrink-0" /> Potente antena WiFi (llega a todas partes)
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 bg-white p-6 rounded-2xl shadow-xl border-2 border-gray-100 transform hover:scale-[1.01] transition duration-300">
                ...
                <div className="w-full md:w-1/2 text-left">
                    ...
                    <p className="text-gray-600 text-lg mb-4 leading-relaxed">
                        Has leído bien. Conecta el <span className="text-purple-700 font-bold">Mando de REGALO</span> (incluido) y convierte tu TV en una consola. Los niños o nietos pueden jugar a los hits sin que gastes 500 € en una consola.
                    </p>
                    <ul className="space-y-2">
                        <li className="flex items-center gap-2 font-bold text-gray-800">
                        ...
                        <li className="flex items-center gap-2 font-bold text-gray-800">
                            <CheckCircle2 className="text-green-500 shrink-0" /> Ahorras cientos de euros
                        </li>
                    </ul>
                </div>
            </div>
