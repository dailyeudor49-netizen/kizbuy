    ...
    <section className="py-12 bg-white">
      <div className="max-w-5xl mx-auto px-4">
        <h2 className="text-3xl font-black text-center mb-10 uppercase text-gray-900 leading-tight">
          ...
          <span className="text-green-600">COMO UN JUEGO DE NIÑOS</span>
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">ENCHUFA</h3>
            <p className="text-gray-600 px-4">
              Conecta el cable HDMI al televisor. No necesitas llamar a un técnico, solo encuentra un puerto libre en la parte trasera del TV.
            </p>
          </div>
