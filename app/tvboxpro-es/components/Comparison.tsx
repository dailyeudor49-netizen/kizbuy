...
const comparisonData = [
    {
        ...
        us: { text: `Solo ${PRICE_PROMO} ${CURRENCY}`, sub: "Pago único", highlight: true },
        them: { text: "Más de 500 €", sub: "Precio de un TV nuevo", highlight: false }
    },
    {
        feature: "¿Funciona en TV viejos?",
        us: { text: "SÍ, HASTA 10 AÑOS", sub: "Solo necesitas HDMI", highlight: false },
        them: { text: "No", sub: "Tienes que comprar uno nuevo", highlight: false }
    },
    {
        feature: "Instalación",
        us: { text: "30 Segundos", sub: "Lo haces tú mismo", highlight: false },
        them: { text: "Complicada", sub: "Cuentas, WiFi, Canales...", highlight: false }
    },
    {
        feature: "Portabilidad",
        us: { text: "SÍ, A TODAS PARTES", sub: "Vacaciones, Hotel, Casa rural", highlight: false },
        them: { text: "NO", sub: "Se queda en un sitio", highlight: false }
    },
    {
        feature: "¿Videojuegos?",
        us: { text: "INCLUIDO", sub: "+ Mando de Regalo", highlight: true },
        them: { text: "APARTE", sub: "Necesitas una consola", highlight: false }
    },
    {
        feature: "Vida útil",
        us: { text: "PARA AÑOS", sub: "Solo actualizas el box", highlight: false },
        them: { text: "SE QUEDA OBSOLETO", sub: "El TV se vuelve lento", highlight: false }
    }
];
    ...
    <section className="bg-white py-12 px-4 border-t-8 border-gray-100">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-center text-gray-600 mb-8 text-lg">
          Mira cuánto ganas en comparación con comprar un Smart TV nuevo.
        </p>
        ...
        <div className="hidden md:block overflow-hidden rounded-xl border-2 border-gray-200 shadow-2xl">
          <table className="w-full text-center border-collapse">
            <thead>
              <tr>
                <th className="p-4 bg-gray-50 w-1/3 text-gray-500 font-bold uppercase text-sm tracking-wider">Característica</th>
                <th className="p-4 bg-green-600 text-white w-1/3 border-b-4 border-green-800 relative">
                    ...
                    <div className="absolute top-0 right-0 bg-yellow-400 text-black text-xs font-bold px-2 py-1 shadow-sm">GANADOR</div>
                </th>
        ...
        <div className="md:hidden space-y-6">
            ...
            <div className="text-center mt-6">
                <p className="text-sm text-gray-500 italic">
                    Resultado: El Box gana 6 a 0 en relación calidad/precio.
                </p>
            </div>
        </div>
