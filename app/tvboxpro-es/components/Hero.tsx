  ...
  return (
    <section className="bg-white pb-8">
      ...
      <div className="bg-red-600 text-white text-center py-2 font-bold text-sm md:text-base px-2 uppercase tracking-wide animate-pulse">
        ⚠️ Alta demanda: Últimas unidades en stock
      </div>

      <div className="max-w-4xl mx-auto px-4 pt-6">
        {/* Headline */}
        <h1 className="text-3xl md:text-5xl font-black text-center leading-tight mb-4 text-gray-900">
          CONVIERTE TU VIEJO TELEVISOR EN <span className="text-white bg-red-600 px-2 transform skew-x-[-10deg] inline-block">CINE, ESTADIO Y CONSOLA</span>
        </h1>
        <p className="text-center text-gray-700 text-lg md:text-xl font-medium mb-6 leading-relaxed">
          El primer Box "Todo-en-uno" que lleva <span className="font-bold underline">Películas, Deporte en vivo y Juegos</span> a cualquier televisor en 30 segundos. <span className="bg-yellow-100 px-1">Tan fácil de usar como un mando a distancia.</span>
        </p>
        ...
        <div className="flex justify-center items-center gap-2 mb-6">
          ...
          <span className="font-bold text-gray-700 underline decoration-green-500 decoration-2">12.450 Españoles lo usan hoy</span>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start border-4 border-gray-100 p-4 rounded-xl bg-gray-50 shadow-xl">
          ...
          <div className="w-full md:w-1/2">
            <div className="relative mb-2 group">
                <div className="absolute top-2 left-2 bg-green-600 text-white font-bold px-3 py-1 text-sm rounded shadow-lg z-10 flex items-center gap-1">
                    <Zap size={16} fill="white"/> TECNOLOGÍA 2025
                </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <ul className="space-y-4 mb-6 text-left w-full">
              <li className="flex items-start gap-3">
                ...
                <span className="text-lg text-gray-800 leading-tight">
                  <span className="text-red-600 font-bold">Cine en casa:</span> Todas las apps (Netflix, YouTube, HBO Max) <span className="font-bold">listas para usar</span>.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 bg-green-600 rounded-full p-1 shrink-0"><Check size={16} className="text-white" strokeWidth={4}/></div>
                <span className="text-lg text-gray-800 leading-tight">
                  <span className="text-red-600 font-bold">Deporte sin cortes:</span> Mira La Liga y Champions en DAZN/Movistar+ en calidad 4K <span className="font-bold">sin buffering</span>.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 bg-green-600 rounded-full p-1 shrink-0"><Check size={16} className="text-white" strokeWidth={4}/></div>
                <span className="text-lg text-gray-800 leading-tight">
                  <span className="text-red-600 font-bold">Tu TV se convierte en Consola:</span> Ahorra en PlayStation. Mando incluido en el paquete.
                </span>
              </li>
            </ul>
            ...
            >
              ...
              <span className="block text-sm font-normal mt-1 opacity-90 text-yellow-100">Pago contra reembolso (al recibir)</span>
            </button>
            ...
            <div className="w-full grid grid-cols-3 gap-2 py-3 border-t border-gray-200">
                <div className="flex flex-col items-center justify-start text-center">
                    ...
                    <span className="text-[10px] md:text-xs font-bold text-gray-700 leading-tight">PAGO<br/>CONTRA REEMBOLSO</span>
                </div>
                <div className="flex flex-col items-center justify-start text-center border-l border-r border-gray-200">
                    ...
                    <span className="text-[10px] md:text-xs font-bold text-gray-700 leading-tight">ENVÍO<br/>24/48 HORAS</span>
                </div>
                <div className="flex flex-col items-center justify-start text-center">
                    <ShieldCheck className="text-green-600 mb-1" size={24} />
                    <span className="text-[10px] md:text-xs font-bold text-gray-700 leading-tight">GARANTÍA<br/>2 AÑOS</span>
                </div>
            </div>
