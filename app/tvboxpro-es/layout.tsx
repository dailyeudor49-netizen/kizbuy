...
export const metadata = {
  ...
  description: 'El primer Box "Todo-en-uno" que lleva películas, deporte en vivo y juegos a cualquier televisor.',
};
  ...
  return (
    <>
      ...
      <Script
        ...
        strategy="lazyOnload"
      />
      <Script id="google-ads-es" strategy="afterInteractive">
        {`
