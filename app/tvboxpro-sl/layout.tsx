...
export const metadata = {
  ...
  description: 'Prvi "Vse v enem" Box, ki prinaša filme, šport v živo in igre na kateri koli televizor.',
};

export default function TvboxproSlLayout({
  children,
}: {
  ...
  return (
    <>
      ...
      <Script
        ...
        strategy="lazyOnload"
      />
      <Script id="google-ads-sl" strategy="afterInteractive">
        {`
