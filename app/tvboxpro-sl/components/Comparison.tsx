...
const comparisonData = [
    {
        feature: "Skupna cena",
        us: { text: `Samo ${PRICE_PROMO} ${CURRENCY}`, sub: "Enkratno placilo", highlight: true },
        them: { text: "Vec kot 500 EUR", sub: "Cena novega TV", highlight: false }
    },
    {
        feature: "Deluje na starih TV?",
        us: { text: "DA, TUDI 10-LETNIH", sub: "Potrebujete samo HDMI", highlight: false },
        them: { text: "Ne", sub: "Morate kupiti novega", highlight: false }
    },
    {
        feature: "Namestitev",
        us: { text: "30 Sekund", sub: "Naredite sami", highlight: false },
        them: { text: "Zapletena", sub: "Racuni, WiFi, Kanali...", highlight: false }
    },
    {
        feature: "Mobilnost",
        us: { text: "DA, POVSOD", sub: "Pocitnice, Hotel, Vikend", highlight: false },
        them: { text: "NE", sub: "Ostane na mestu", highlight: false }
    },
    {
        feature: "Videoigre?",
        us: { text: "V PAKETU", sub: "+ Kontroler Brezplacno", highlight: true },
        them: { text: "POSEBEJ", sub: "Potrebujete konzolo", highlight: false }
    },
    {
        feature: "Zivljenjska doba",
        us: { text: "ZA LETA", sub: "Posodobite samo box", highlight: false },
        them: { text: "ZASTAREVA", sub: "TV se upocasni", highlight: false }
    }
];
    ...
    <section className="bg-white py-12 px-4 border-t-8 border-gray-100">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-black text-center mb-2 uppercase text-gray-900 leading-tight">
          NE MECITE STAREGA TELEVIZORJA!
        </h2>
        <p className="text-center text-gray-600 mb-8 text-lg">
          Poglejte, koliko prihranite v primerjavi z nakupom novega Smart TV.
        </p>
        ...
        <div className="hidden md:block overflow-hidden rounded-xl border-2 border-gray-200 shadow-2xl">
          <table className="w-full text-center border-collapse">
            <thead>
              <tr>
                <th className="p-4 bg-gray-50 w-1/3 text-gray-500 font-bold uppercase text-sm tracking-wider">Lastnost</th>
        ...
        <div className="md:hidden space-y-6">
            ...
            <div className="text-center mt-6">
                <p className="text-sm text-gray-500 italic">
                    Rezultat: Box zmaga 6:0 v razmerju cena/kakovost.
                </p>
            </div>
        </div>
