      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-3">Premijska tehnologija in elektronika po veleprodajnih cenah. Hitra dostava po vsem svetu.</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><a href="https://kizbuy.com/products#speakers" className="hover:text-amber-400">Zvocniki</a></li>
              <li><a href="https://kizbuy.com/products#power" className="hover:text-amber-400">Power Bank</a></li>
              <li><a href="https://kizbuy.com/products#wearables" className="hover:text-amber-400">Nosljive naprave</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><a href="https://kizbuy.com/cookie-policy" className="hover:text-amber-400">Piskotki</a></li>
              <li><a href="https://kizbuy.com/terms-of-service" className="hover:text-amber-400">Pogoji</a></li>
            </ul>
          </div>
        </div>
        <div className="mt-8 pt-6 border-t border-gray-800 text-center">
          <p className="text-amber-400 font-semibold mb-2">TV Box Pro je registrirana blagovna znamka Kizbuy Ltd.</p>
        </div>
