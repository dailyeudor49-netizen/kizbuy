    ...
    <section className="py-12 bg-white">
      <div className="max-w-5xl mx-auto px-4">
        <h2 className="text-3xl font-black text-center mb-10 uppercase text-gray-900 leading-tight">
          ENOSTAVNA NAMESTITEV? <br/>
          <span className="text-green-600">KOT OTROSKA IGRA</span>
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">PRIKLJUCITE</h3>
            <p className="text-gray-600 px-4">
              Prikljucite HDMI kabel na televizor. Ni vam treba klicati tehnika, preprosto poiscite prost prikljucek na zadnji strani TV.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">POVEZITE</h3>
            <p className="text-gray-600 px-4">
              Vklopite napravo in jo povezite z domacim WiFi (ali z internetom iz mobilnika). Deluje z vsemi operaterji.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">GLEJTE</h3>
            <p className="text-gray-600 px-4">
              Koncano! Imate dostop do tisocih kanalov, filmov, serij in iger. Brez pogodb in brez stresa.
            </p>
          </div>
