  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && !alreadyTracked) {
      ...
      script.onload = () => {
        ...
        if (ecAddress) userData.address = { street: ecAddress, country: 'DE' };
        if (Object.keys(userData).length > 0) window.gtag('set', 'user_data', userData);

        // Purchase DE conversion
        window.gtag('event', 'conversion', {
          'send_to': 'AW-17261661993/GePhCNj0wN4bEKmegKdA',
          'value': ecValue,
          'currency': 'EUR',
      ...
      <div className="ty-box" style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            <div style={{ width: '32px', height: '32px', background: '#16a34a', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '0.75rem' }}>€</div>
            <div>
