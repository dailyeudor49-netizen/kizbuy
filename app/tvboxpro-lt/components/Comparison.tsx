...
const comparisonData = [
    {
        feature: "Bendra kaina",
        us: { text: `Tik ${PRICE_PROMO} ${CURRENCY}`, sub: "Vienkartinis mokėjimas", highlight: true },
        them: { text: "Virš 500 €", sub: "Naujo TV kaina", highlight: false }
    },
    {
        feature: "Ar veikia senuose TV?",
        us: { text: "TAIP, NET 10 METŲ", sub: "Reikia tik HDMI", highlight: false },
        them: { text: "Ne", sub: "Reikia pirkti naują", highlight: false }
    },
    {
        feature: "Instaliacija",
        us: { text: "30 Sekundžių", sub: "Darote patys", highlight: false },
        them: { text: "Sudėtinga", sub: "Paskyros, WiFi, Kanalai...", highlight: false }
    },
    {
        feature: "Mobilumas",
        us: { text: "TAIP, VISUR", sub: "Atostogos, Viešbutis, Sodyba", highlight: false },
        them: { text: "NE", sub: "Stovi vietoje", highlight: false }
    },
    {
        feature: "Vaizdo žaidimai?",
        us: { text: "KOMPLEKTE", sub: "+ Pultas Dovana", highlight: true },
        them: { text: "ATSKIRAI", sub: "Reikia konsolės", highlight: false }
    },
    {
        feature: "Tarnavimo laikas",
        us: { text: "METAMS", sub: "Atnaujinate tik box'ą", highlight: false },
        them: { text: "PASENSTA", sub: "TV tampa lėtas", highlight: false }
    }
];
    ...
    <section className="bg-white py-12 px-4 border-t-8 border-gray-100">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-black text-center mb-2 uppercase text-gray-900 leading-tight">
          NEIŠMESKITE SENO TELEVIZORIAUS!
        </h2>
        <p className="text-center text-gray-600 mb-8 text-lg">
          Pažiūrėkite, kiek laimite palyginus su naujo Smart TV pirkimu.
        </p>
        ...
        <div className="hidden md:block overflow-hidden rounded-xl border-2 border-gray-200 shadow-2xl">
          <table className="w-full text-center border-collapse">
            <thead>
              <tr>
                <th className="p-4 bg-gray-50 w-1/3 text-gray-500 font-bold uppercase text-sm tracking-wider">Savybė</th>
                <th className="p-4 bg-green-600 text-white w-1/3 border-b-4 border-green-800 relative">
                    ...
                    <div className="absolute top-0 right-0 bg-yellow-400 text-black text-xs font-bold px-2 py-1 shadow-sm">NUGALĖTOJAS</div>
                </th>
        ...
        <div className="md:hidden space-y-6">
            ...
            <div className="text-center mt-6">
                <p className="text-sm text-gray-500 italic">
                    Rezultatas: Box laimi 6:0 kainos/kokybės santykiu.
                </p>
            </div>
        </div>
