    ...
    <section className="py-12 bg-white">
      <div className="max-w-5xl mx-auto px-4">
        <h2 className="text-3xl font-black text-center mb-10 uppercase text-gray-900 leading-tight">
          LENGVA INSTALIACIJA? <br/>
          <span className="text-green-600">KAIP VAIKŲ ŽAIDIMAS</span>
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">PRIJUNKITE</h3>
            <p className="text-gray-600 px-4">
              Prijunkite HDMI kabelį prie televizoriaus. Nereikia kviesti techniko, tiesiog suraskite laisvą prievadą TV gale.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">PRISIJUNKITE</h3>
            <p className="text-gray-600 px-4">
              Įjunkite įrenginį ir prijunkite prie namų WiFi (arba telefono interneto). Veikia su visais operatoriais.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">ŽIŪRĖKITE</h3>
            <p className="text-gray-600 px-4">
              Paruošta! Turite prieigą prie tūkstančių kanalų, filmų, serialų ir žaidimų. Be sutarčių ir be streso.
            </p>
          </div>
