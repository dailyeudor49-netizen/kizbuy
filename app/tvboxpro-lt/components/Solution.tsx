    ...
    <section className="py-12 bg-gray-50 px-4">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl md:text-5xl font-black text-center mb-4 text-gray-900 leading-tight uppercase">
          <span className="text-red-600 bg-yellow-200 px-2">SVAJONIŲ</span> ĮRENGINYS JŪSŲ NAMAMS
        </h2>
        <p className="text-center text-xl text-gray-600 mb-12 max-w-3xl mx-auto font-medium">
          Pamirškite viską, ką žinote apie televiziją. Štai kaip šis <strong>4K Ultra HD</strong> box pakeičia jūsų gyvenimą iškart po prijungimo:
        </p>
        ...
        <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 bg-white p-6 rounded-2xl shadow-xl border-2 border-gray-100 transform hover:scale-[1.01] transition duration-300">
                ...
                <div className="w-full md:w-1/2 text-left">
                    <h3 className="text-2xl md:text-3xl font-black text-gray-900 mb-3 uppercase leading-none">
                        1. KINAS 4K (GERIAU NEI REALYBĖ)
                    </h3>
                    <p className="text-gray-600 text-lg mb-4 leading-relaxed">
                        Tai ne tiesiog „televizijos žiūrėjimas", tai pasinėrimas į filmą. Dėl <strong>4K Ultra HD su HDR</strong> spalvos atgyja, o detalės neįtikėtinos. Netflix, YouTube ir HBO Max paleidžiami akimirksniu.
                    </p>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-8 bg-white p-6 rounded-2xl shadow-xl border-2 border-gray-100 transform hover:scale-[1.01] transition duration-300">
                <div className="w-full md:w-1/2">
                    {/* Video Sport */}
                    <div className="relative rounded-xl overflow-hidden shadow-lg border-4 border-gray-900 aspect-square">
                        <div className="absolute top-2 right-2 bg-green-600 text-white text-xs font-bold px-2 py-1 z-10 rounded uppercase animate-pulse">BE STRIGIMŲ</div>
                        <video autoPlay loop muted playsInline className="w-full h-full object-cover">
                ...
                <div className="w-full md:w-1/2 text-left">
                    ...
                    <p className="text-gray-600 text-lg mb-4 leading-relaxed">
                        Matote kiekvieną žolės stiebelį. Dėl <strong>sklandaus 4K 60fps</strong>, A Lygos ir Čempionų Lygos (Go3, TV3) rungtynės nestringa net per derbius. Jūsų draugai norės žiūrėti rungtynes tik pas jus.
                    </p>
                    <ul className="space-y-2">
                        <li className="flex items-center gap-2 font-bold text-gray-800">
                            <CheckCircle2 className="text-green-500 shrink-0" /> Sklandus srautas be buferizavimo
                        </li>
                        <li className="flex items-center gap-2 font-bold text-gray-800">
                            <CheckCircle2 className="text-green-500 shrink-0" /> Galinga WiFi antena (pasiekia visur)
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 bg-white p-6 rounded-2xl shadow-xl border-2 border-gray-100 transform hover:scale-[1.01] transition duration-300">
                <div className="w-full md:w-1/2">
                    {/* GIF Gaming */}
                    <div className="relative rounded-xl overflow-hidden shadow-lg border-4 border-gray-900 aspect-square">
                         <div className="absolute top-2 left-2 bg-purple-600 text-white text-xs font-bold px-2 py-1 z-10 rounded uppercase animate-pulse">PULTAS KOMPLEKTE</div>
                ...
                <div className="w-full md:w-1/2 text-left">
                    ...
                    <p className="text-gray-600 text-lg mb-4 leading-relaxed">
                        Teisingai perskaitėte. Prijunkite <span className="text-purple-700 font-bold">DOVANĄ Pultą</span> (komplekte) ir paverskite TV konsole. Vaikai ar anūkai gali žaisti hitus neišleidžiant 500 € konsolei.
                    </p>
                    <ul className="space-y-2">
                        <li className="flex items-center gap-2 font-bold text-gray-800">
                        ...
                        <li className="flex items-center gap-2 font-bold text-gray-800">
                            <CheckCircle2 className="text-green-500 shrink-0" /> Sutaupote šimtus eurų
                        </li>
                    </ul>
                </div>
            </div>
