        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-3">
              Premium technologijos ir elektronika didmeninėmis kainomis. Greitas pristatymas visame pasaulyje.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><a href="https://kizbuy.com/products#wearables" className="hover:text-amber-400">Išmanieji prietaisai</a></li>
              <li><a href="https://kizbuy.com/products#accessories" className="hover:text-amber-400">Aksesuarai</a></li>
            </ul>
          </div>
