...
// Network config for LT - TODO: Update with actual Lithuania offer IDs
const NETWORK_CONFIG = {
  uid: '0191b25c-22d2-7f55-9d9b-79b67cebbff3',
  key: 'e0fe8e75c501eccab21f8d',
  offer: 'XXXX', // TODO: Update with Lithuania offer ID
  lp: 'XXXX', // TODO: Update with Lithuania LP ID
};
      ...
      return (
          <section id="order-form" className="py-16 px-4 bg-green-50 min-h-[50vh] flex items-center justify-center">
              <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-2xl text-center border-4 border-green-500">
                  ...
                  <h2 className="text-3xl font-black text-gray-900 mb-4">AČIŪ, {formState.name}!</h2>
                  <p className="text-xl text-gray-700 mb-6">Jūsų užsakymas patvirtintas.</p>
                  <p className="text-gray-600">Mūsų darbuotojas netrukus susisieks su jumis numeriu <span className="font-bold">{formState.phone}</span>, kad suderintų pristatymą.</p>
                  <div className="mt-6 bg-yellow-100 p-4 rounded-lg border border-yellow-300">
                    <p className="font-bold text-gray-800 uppercase text-sm mb-1">Suma mokėti kurjeriui:</p>
    ...
    <section id="order-form" className="py-12 px-4 bg-gray-200">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden border-2 border-gray-300">
        ...
        <div className="bg-red-600 text-white p-6 text-center">
          <h2 className="text-3xl font-black uppercase mb-2">UŽSAKYMO FORMA</h2>
          <p className="text-lg font-medium">Užpildykite žemiau, kad užsirezervuotumėte akciją</p>
          ...
          <div className="flex items-center justify-center gap-2 mt-4 bg-red-700 py-2 rounded-lg border border-red-500">
            ...
            <span className="font-bold text-xl">Pasiūlymas baigiasi po: {formatTime(timeLeft)}</span>
          </div>
        </div>
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="bg-yellow-50 border-2 border-yellow-400 p-4 rounded-lg mb-8 shadow-sm">
            <h3 className="font-bold text-gray-800 text-lg mb-2 border-b border-yellow-200 pb-2">Užsakymo apžvalga:</h3>
            <div className="flex justify-between items-center mb-1 text-lg">
             ...
             <div className="flex justify-between items-center text-gray-700 text-sm mb-2">
              <span className="flex items-center gap-1"><Truck size={16}/> Greitas pristatymas (24/48 val.)</span>
              <span className="font-bold text-green-600 flex items-center gap-1">
                AKTYVUS <Check size={16} strokeWidth={3} />
              </span>
            </div>
            <div className="flex justify-between items-center mt-3 pt-3 border-t-2 border-yellow-200 text-2xl font-black text-red-600">
              <span>IŠ VISO (Mokėjimas pristatymo metu):</span>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-gray-700 font-bold mb-2 text-lg">Vardas ir Pavardė <span className="text-red-500">*</span></label>
              <input
                type="text"
                name="name"
                required
            ...
            <div>
              <label className="block text-gray-700 font-bold mb-2 text-lg">Telefono numeris <span className="text-red-500">*</span></label>
              <input
                type="tel"
                name="phone"
                required
                ...
                onChange={handleChange}
              />
              <p className="text-sm text-gray-500 mt-1 font-medium bg-blue-50 p-2 rounded text-blue-800">ℹ️ Svarbu: Kurjeris paskambins šiuo numeriu prieš pristatymą.</p>
            </div>

            <div>
              <label className="block text-gray-700 font-bold mb-2 text-lg">Pilnas pristatymo adresas <span className="text-red-500">*</span></label>
              <textarea
                name="address"
                required
                placeholder="Miestas, Gatvė, Namo numeris, Butas (arba atsiėmimo taškas)"
                rows={3}
            ...
            <div className="bg-gray-100 p-4 rounded-lg flex items-center gap-3 text-sm text-gray-600 border border-gray-200">
               ...
               <span>Jokios rizikos: mokate grynaisiais/kortele tik gavę siuntą.</span>
            </div>
            ...
            >
              ...
              <span className="block text-lg font-normal mt-2 text-green-100">Greitas Pristatymas ir Mokėjimas pristatymo metu</span>
            </button>
          </form>
        </div>
      </div>
