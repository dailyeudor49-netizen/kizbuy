...
export default function RobotCleanProXPage() {
  ...
  return (
    <>
      ...
      <img src="https://offers.supertrendaffiliateprogram.com/forms/api/ck/?o=596&uid=01981ccf-4474-7c39-97eb-9407221996c2&lp=596" style={{width:'1px',height:'1px',display:'none'}} alt="" />
