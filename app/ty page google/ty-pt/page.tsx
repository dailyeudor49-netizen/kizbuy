  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && !alreadyTracked) {
      ...
      script.onload = async () => {
        ...
        // Purchase PT conversion
        window.gtag('config', 'AW-17261661993');
        window.gtag('event', 'conversion', {
          'send_to': 'AW-17261661993/8mfdCOuQ3M8bEKmegKdA',
          'value': ecValue,
          'currency': 'EUR',
    ...
    <div className="ty-container" style={{
      ...
      <div className="ty-box" style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.875rem', color: '#92400e', marginBottom: '0.25rem' }}>Número da encomenda</div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>Pagamento à cobrança</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Pagará em dinheiro ao estafeta</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>Envio gratuito</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Entrega em 2-3 dias úteis</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>30 dias para devolução</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Reembolso se não estiver satisfeito</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>2 anos de garantia</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Em todos os produtos</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '0.25rem' }}>Precisa de ajuda ou quer solicitar uma devolução?</div>
          <a href="mailto:info@kizbuy.com" style={{ color: '#FF8C00', fontWeight: 600, textDecoration: 'none', fontSize: '0.95rem' }}>info@kizbuy.com</a>
          <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginTop: '0.5rem' }}>Pode solicitar a devolução no prazo de 30 dias se não estiver satisfeito com o produto</div>
        </div>
