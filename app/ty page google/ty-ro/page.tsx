  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && !alreadyTracked) {
      ...
      script.onload = async () => {
        ...
        // Purchase RO conversion
        window.gtag('config', 'AW-17261661993');
        window.gtag('event', 'conversion', {
          'send_to': 'AW-17261661993/C_GaCLWl488bEKmegKdA',
          'value': ecValue,
          'currency': 'RON',
    ...
    <div className="ty-container" style={{
      ...
      <div className="ty-box" style={{
        ...
        <p style={{
          ...
          Comanda dumneavoastră a fost primită cu succes.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.875rem', color: '#92400e', marginBottom: '0.25rem' }}>Numărul comenzii</div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            <div style={{ width: '32px', height: '32px', background: '#16a34a', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '0.8rem' }}>lei</div>
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>Plata la livrare</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Veți plăti în numerar curierului</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>Livrare gratuită</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Livrare în 2-3 zile lucrătoare</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>30 de zile pentru returnare</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Banii înapoi dacă nu sunteți mulțumit</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>2 ani garanție</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Pentru toate produsele</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '0.25rem' }}>Aveți nevoie de ajutor sau doriți să returnați produsul?</div>
          <a href="mailto:info@kizbuy.com" style={{ color: '#FF8C00', fontWeight: 600, textDecoration: 'none', fontSize: '0.95rem' }}>info@kizbuy.com</a>
          <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginTop: '0.5rem' }}>Puteți solicita returnarea în termen de 30 de zile dacă nu sunteți mulțumit de produs</div>
        </div>
