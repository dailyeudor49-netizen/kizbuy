...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && !alreadyTracked) {
      ...
      const ecValue = parseFloat(sessionStorage.getItem('ec_value') || '69.90');
      ...
      script.onload = () => {
        ...
        if (ecAddress) userData.address = { street: ecAddress, country: 'IT' };
        if (Object.keys(userData).length > 0) window.gtag('set', 'user_data', userData);

        // Purchase IT conversion - UPDATE CONVERSION LABEL WHEN PROVIDED
        window.gtag('event', 'conversion', {
          'send_to': 'AW-17261661993/TITANSAW_IT_CONVERSION_LABEL',
          'value': ecValue,
          'currency': 'EUR',
    ...
    <div className="ty-container" style={{
      ...
      <div className="ty-box" style={{
        ...
        <div style={{
          ...
          <a href="mailto:info@kizbuy.com" style={{ color: '#dc3545', fontWeight: 600, textDecoration: 'none', fontSize: '0.95rem' }}>info@kizbuy.com</a>
        </div>
