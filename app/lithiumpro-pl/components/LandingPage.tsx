               ...
               <div className="relative mx-auto max-w-[500px] md:max-w-full md:sticky md:top-24">
                   ...
                   <div className="flex justify-end mt-4 pr-2">
                      <div className="bg-red-600 text-white border-[3px] border-white rounded-2xl shadow-[0_10px_20px_rgba(0,0,0,0.3)] p-3 md:p-4 transform rotate-[-3deg] flex flex-col items-center hover:scale-105 transition-transform duration-300">
                         ...
                         <span className="text-[10px] md:text-xs font-bold uppercase leading-none text-white tracking-wider">ZESTAW AKCESORIÓW</span>
                         <span className="text-xl md:text-2xl font-black uppercase leading-none text-yellow-300 my-1 drop-shadow-md">GRATIS</span>
                         <span className="text-[10px] md:text-xs uppercase font-black bg-white text-red-600 px-2 py-0.5 rounded shadow-sm">Wart 400zł</span>
                      </div>
                   </div>
