    ...
    <section className="w-full bg-white pb-8 pt-2 px-3 md:px-4 border-b-8 border-blue-600 overflow-hidden">
      <div className="bg-yellow-300 text-center py-3 px-2 mb-6 -mx-3 md:-mx-4 shadow-sm border-b border-yellow-400">
        <p className="text-sm md:text-xl font-black text-red-700 uppercase tracking-wide animate-pulse leading-tight">
          ⚠️ FIGYELEM: Az &quot;Egészséges Gerinc&quot; ajánlat éjfélkor lejár
        </p>
      </div>
        ...
        <div className="lg:hidden flex flex-col gap-8">
          ...
          <div className="space-y-4 px-1">
            <div className="flex items-start bg-blue-50 p-4 rounded-xl border border-blue-100 shadow-sm">
                ...
                <div>
                    <h4 className="font-black text-gray-900 text-lg uppercase mb-1 leading-none">GERINCEGYENESÍTÉS</h4>
                    <p className="text-base text-gray-800 leading-snug mt-1">A nyakat, hátat és medencét természetes tengelyben tartja. <span className="bg-yellow-200 px-1 font-bold">Vége a merev reggeleknek.</span></p>
                </div>
            </div>
            <div className="flex items-start bg-blue-50 p-4 rounded-xl border border-blue-100 shadow-sm">
                <CheckCircle2 className="w-8 h-8 text-blue-600 mr-4 flex-shrink-0 mt-1" />
            ...
            <div className="flex items-start bg-blue-50 p-4 rounded-xl border border-blue-100 shadow-sm">
                ...
                <div>
                    ...
                    <p className="text-base text-gray-800 leading-snug mt-1">A <strong>Memory HD + HR</strong> szerkezet (7cm) befogadja a vállakat és csípőt besüllyedés nélkül.</p>
                </div>
            </div>
            <div className="flex items-start bg-blue-50 p-4 rounded-xl border border-blue-100 shadow-sm">
                <CheckCircle2 className="w-8 h-8 text-blue-600 mr-4 flex-shrink-0 mt-1" />
                <div>
                    ...
                    <p className="text-base text-gray-800 leading-snug mt-1"><strong>Aloe Vera huzat cipzárral</strong> mosáshoz + oldalsó <strong>3D Mesh háló</strong> az izzadás ellen.</p>
                </div>
            </div>
            <div className="flex items-start bg-blue-50 p-4 rounded-xl border border-blue-100 shadow-sm">
                ...
                <div>
                    ...
                    <p className="text-base text-gray-800 leading-snug mt-1">Csúszásmentes alj + <strong>4 széles megerősített gumi</strong>. <span className="bg-yellow-200 px-1 font-bold">Egy milimétert sem mozdul.</span></p>
                </div>
            </div>
            <div className="flex items-start bg-blue-50 p-4 rounded-xl border border-blue-100 shadow-sm">
                <Sparkles className="w-8 h-8 text-blue-600 mr-4 flex-shrink-0 mt-1" />
                <div>
                    <h4 className="font-black text-gray-900 text-lg uppercase mb-1 leading-none">SPÓROLJON 50.000 Ft-OT</h4>
            ...
            <div className="text-center mt-6 mb-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-3 text-left shadow-sm">
                    <div className="flex items-center text-blue-800 font-black text-xs uppercase mb-1">
                        <Info className="w-4 h-4 mr-1" /> Miért kerül minden méret ugyanannyiba?
                    </div>
                    <p className="text-xs text-gray-700 leading-tight">
                        A raktár felszabadítása érdekében <strong>csökkentettük a nagy méretek árait</strong> (King/Dupla) az Egyszemélyes árára.
                        <br/><span className="text-red-600 font-bold">Használja ki, a kicsiért fizet, de nagyot visz!</span>
                    </p>
                </div>
            </div>
            <div className="mb-6">
                <p className="text-center text-base font-black text-gray-800 mb-4 uppercase flex items-center justify-center">
                    <span className="w-3 h-3 bg-blue-600 rounded-full mr-2"></span> Válassza ki a méretét
                </p>
          ...
          <div className="flex flex-row gap-12 items-start mb-10">
            ...
            <div className="w-1/2 space-y-4">
              <div className="flex items-start bg-blue-50 p-5 rounded-xl border border-blue-100 shadow-sm">
                  ...
                  <div>
                      <h4 className="font-black text-gray-900 text-2xl uppercase mb-1 leading-none">GERINCEGYENESÍTÉS</h4>
                      <p className="text-xl text-gray-800 leading-snug mt-1">A nyakat, hátat és medencét természetes tengelyben tartja. <span className="bg-yellow-200 px-1 font-bold">Vége a merev reggeleknek.</span></p>
                  </div>
              </div>
              <div className="flex items-start bg-blue-50 p-5 rounded-xl border border-blue-100 shadow-sm">
                  <CheckCircle2 className="w-10 h-10 text-blue-600 mr-4 flex-shrink-0 mt-1" />
              ...
              <div className="flex items-start bg-blue-50 p-5 rounded-xl border border-blue-100 shadow-sm">
                  ...
                  <div>
                      ...
                      <p className="text-xl text-gray-800 leading-snug mt-1">A <strong>Memory HD + HR</strong> szerkezet (7cm) befogadja a vállakat és csípőt besüllyedés nélkül.</p>
                  </div>
              </div>
              <div className="flex items-start bg-blue-50 p-5 rounded-xl border border-blue-100 shadow-sm">
                  <CheckCircle2 className="w-10 h-10 text-blue-600 mr-4 flex-shrink-0 mt-1" />
                  <div>
                      ...
                      <p className="text-xl text-gray-800 leading-snug mt-1"><strong>Aloe Vera huzat cipzárral</strong> mosáshoz + oldalsó <strong>3D Mesh háló</strong> az izzadás ellen.</p>
                  </div>
              </div>
              <div className="flex items-start bg-blue-50 p-5 rounded-xl border border-blue-100 shadow-sm">
                  ...
                  <div>
                      ...
                      <p className="text-xl text-gray-800 leading-snug mt-1">Csúszásmentes alj + <strong>4 széles megerősített gumi</strong>. <span className="bg-yellow-200 px-1 font-bold">Egy milimétert sem mozdul.</span></p>
                  </div>
              </div>
              <div className="flex items-start bg-blue-50 p-5 rounded-xl border border-blue-100 shadow-sm">
                  <Sparkles className="w-10 h-10 text-blue-600 mr-4 flex-shrink-0 mt-1" />
                  <div>
                      <h4 className="font-black text-gray-900 text-2xl uppercase mb-1 leading-none">SPÓROLJON 50.000 Ft-OT</h4>
            ...
            <div className="flex flex-row items-center justify-between gap-8 mt-4">
              <div className="flex-1">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-3 text-left shadow-sm max-w-md">
                    <div className="flex items-center text-blue-800 font-black text-sm uppercase mb-1"><Info className="w-4 h-4 mr-1" /> Miért kerül minden méret ugyanannyiba?</div>
                    <p className="text-sm text-gray-700 leading-tight">A raktár felszabadítása érdekében <strong>csökkentettük a nagy méretek árait</strong>.<span className="text-red-600 font-bold"> Használja ki, a kicsiért fizet, de nagyot visz!</span></p>
                </div>
              </div>
              <div className="flex-1">
                <p className="text-center text-lg font-black text-gray-800 mb-4 uppercase flex items-center justify-center"><span className="w-4 h-4 bg-blue-600 rounded-full mr-2"></span> Válassza ki a méretét</p>
    ...
    <section className="bg-gradient-to-b from-gray-50 to-white py-12 px-4">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl md:text-5xl font-black text-center text-gray-900 mb-4 uppercase leading-tight">
          A matracod <br className="md:hidden"/> <span className="text-red-600 underline decoration-4 decoration-yellow-400">tönkreteszi a gerinced?</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:border-red-400 transition-colors">
                ...
                <h3 className="font-black text-xl text-gray-900 mb-2 uppercase">Nyakmerevség</h3>
                <p className="text-base text-gray-700 font-medium leading-relaxed">Reggel merev a nyakad? Ez azt jelenti, hogy a vállak és a fej <span className="font-bold bg-yellow-100">nincsenek egyenesben</span> alvás közben.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:border-red-400 transition-colors">
                ...
                <p className="text-base text-gray-700 font-medium leading-relaxed">Zsibbadt kézzel vagy lábbal ébredsz? A matrac <span className="font-bold bg-yellow-100">akadályozza a vérkeringést.</span></p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:border-red-400 transition-colors">
                ...
                <p className="text-base text-gray-700 font-medium leading-relaxed">Forgolódsz, kényelmes pozíciót keresve? A tested egész éjjel küzd a kényelemért.</p>
            </div>
        </div>
        <div className="text-center mt-12 p-6 md:p-8 bg-blue-50 rounded-2xl border-2 border-blue-100 max-w-3xl mx-auto">
            <p className="text-xl md:text-3xl font-black text-blue-900 uppercase mb-3 leading-tight">A MEGOLDÁS NEM EGY 300.000 Ft-OS MATRAC</p>
    ...
    <section className="bg-white py-12 md:py-16 px-4 border-t border-gray-200">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 uppercase mb-4 leading-tight">3 SZINTŰ <span className="text-blue-600">ORTOPÉD TECHNOLÓGIA</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-200 group hover:shadow-2xl transition-shadow flex flex-col">
                ...
                <div className="p-6 md:p-8 flex-1">
                    ...
                    <p className="text-gray-700 leading-relaxed text-lg md:text-xl font-medium">A viszkoelasztikus anyag milliméteresen illeszkedik a testhez, kitöltve az üres tereket (ágyéki régió). Lehetővé teszi a gerinc megnyúlását és a porckorongok éjszakai <span className="bg-yellow-100 font-bold px-1 text-gray-900 border-b-2 border-yellow-300">hidratálódását</span>.</p>
                </div>
            </div>
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-200 group hover:shadow-2xl transition-shadow flex flex-col">
                <div className="aspect-square w-full relative">
                    <img src="/images/ortopper-img/profilo-bugnato-wave-opt.gif" alt="Wave Hullámprofil" className="w-full h-full object-cover" />
                ...
                <div className="p-6 md:p-8 flex-1">
                    <h4 className="font-black text-2xl text-gray-900 uppercase mb-3 md:mb-4">&quot;Wave&quot; Hullámprofil</h4>
                    <p className="text-gray-700 leading-relaxed text-lg md:text-xl font-medium">A speciális hullámos megmunkálás minden mozdulatnál <span className="bg-yellow-100 font-bold px-1 text-gray-900 border-b-2 border-yellow-300">passzív mikromasszázst</span> fejt ki. Serkenti a kapilláris mikrokeringést, csökkentve a duzzanatot és a vízvisszatartást.</p>
                </div>
            </div>
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-200 group hover:shadow-2xl transition-shadow flex flex-col">
                <div className="aspect-square w-full relative">
                ...
                <div className="p-6 md:p-8 flex-1">
                    ...
                    <p className="text-gray-700 leading-relaxed text-lg md:text-xl font-medium">A súlyt egyenletesen elosztva <span className="bg-yellow-100 font-bold px-1 text-gray-900 border-b-2 border-yellow-300">7 CM vastagságon</span>, megszünteti a nyomáscsúcsokat a csípőn és a vállakon. Kulcsfontosságú ízületi fájdalmak és zsibbadás esetén.</p>
                </div>
            </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="bg-blue-800 p-6 md:p-8 rounded-3xl border-2 border-blue-700 flex items-start hover:bg-blue-700 transition-colors shadow-lg">
                ...
                <div>
                    ...
                    <p className="text-blue-50 font-medium text-lg md:text-xl leading-snug">Akár háton, akár oldalon alszol, a fedőmatrac fenntartja a természetes tengelyt. Egyenesen ébredsz, anélkül hogy &quot;ropogtatnod&quot; kellene a gerinced.</p>
                </div>
            </div>
            <div className="bg-blue-800 p-6 md:p-8 rounded-3xl border-2 border-blue-700 flex items-start hover:bg-blue-700 transition-colors shadow-lg">
                <Brain className="w-10 h-10 md:w-12 md:h-12 text-green-400 mr-4 md:mr-5 flex-shrink-0 mt-1" />
                <div>
                    <h4 className="font-black text-xl md:text-2xl text-white mb-2 uppercase">3D Mesh Oldalsó Háló</h4>
                    <p className="text-blue-50 font-medium text-lg md:text-xl leading-snug">A zárt fedőmatracokkal ellentétben a mi technikai oldalsó hálónk állandó légáramlást biztosít. <span className="text-white font-bold underline decoration-green-400">Vége az izzadásnak.</span></p>
                </div>
            </div>
            <div className="bg-blue-800 p-6 md:p-8 rounded-3xl border-2 border-blue-700 flex items-start hover:bg-blue-700 transition-colors shadow-lg">
                ...
                <div>
                    ...
                    <p className="text-blue-50 font-medium text-lg md:text-xl leading-snug">Valódi <span className="font-bold text-white bg-blue-600 px-1">csúszásmentes aljjal</span> és 4 széles megerősített gumival felszerelve. Egy milimétert sem mozdul.</p>
                </div>
            </div>
            <div className="bg-blue-800 p-6 md:p-8 rounded-3xl border-2 border-blue-700 flex items-start hover:bg-blue-700 transition-colors shadow-lg">
                ...
                <div>
                    ...
                    <p className="text-blue-50 font-medium text-lg md:text-xl leading-snug">Aloe Vera huzat cipzárral a gyors mosáshoz. Atka- és allergiamentes anyagok, ideális érzékeny személyeknek.</p>
                </div>
            </div>
        </div>
        <div className="text-center mt-12">
             <a href="#order-form" className="inline-block bg-green-500 hover:bg-green-600 text-white font-black text-xl md:text-3xl py-5 px-10 md:py-6 md:px-16 rounded-full shadow-2xl border-b-8 border-green-700 transform transition hover:scale-105 uppercase tracking-wide">ÉREZZE A MEGKÖNNYEBBÜLÉST MOST</a>
             <p className="mt-4 text-sm md:text-lg text-blue-200 font-bold uppercase tracking-widest">14 napos elégedettségi garancia vagy pénzvisszafizetés</p>
        </div>
      </div>
    </section>
  );
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-start gap-10">
            <div className="flex flex-col items-center flex-1">
                ...
                <p className="font-black text-2xl text-gray-900 uppercase mb-2">Kitekerés</p>
                <p className="text-lg text-gray-600 font-medium leading-snug">Nyisd ki a vákuumcsomagolást és kényelmesen terítsd a régi matracra.</p>
            </div>
            ...
            <div className="flex flex-col items-center flex-1">
                ...
                <p className="font-black text-2xl text-gray-900 uppercase mb-2">Rögzítés</p>
                <p className="text-lg text-gray-600 font-medium leading-snug">Csatold a 4 megerősített gumit a sarkokra a tökéletes stabilitásért.</p>
            </div>
            <div className="hidden md:block w-16 h-2 bg-gray-100 mt-10 rounded-full"></div>
            <div className="flex flex-col items-center flex-1">
                ...
                <p className="font-black text-2xl text-gray-900 uppercase mb-2">Aludj</p>
                <p className="text-lg text-gray-600 font-medium leading-snug">Élvezd az azonnali kényelmet és búcsúzz a reggeli fájdalmaktól.</p>
            </div>
        </div>
        <div className="mt-12 bg-yellow-50 inline-block px-6 py-4 rounded-xl border-2 border-yellow-200 text-base md:text-lg text-yellow-900 font-bold max-w-3xl">
            Megjegyzés: <span className="font-black uppercase">Vákuumban összetekert</span> állapotban szállítjuk. Javasoljuk, hogy várj 24-48 órát a teljes térfogat visszanyeréséhez (7cm), de már 4 óra után használhatod.
        </div>
      </div>
    </section>
  );
...
const Comparison: React.FC = () => {
  const features = [
    { name: "Belső Szerkezet", us: { text: "DUPLA RÉTEG (Memory+HR)", highlight: true }, them: "Egyetlen réteg" },
    { name: "Teljes Vastagság", us: { text: "7 CM VALÓS", highlight: true }, them: "Mindössze 3-4 CM" },
    { name: "Támogatás Típusa", us: { text: "Aktív Ortopéd", highlight: false }, them: "Passzív / Puha" },
    { name: "Hatás a Gerincre", us: { text: "Dekompresszió", highlight: false }, them: "Besüllyedés" },
    { name: "Felületi Technológia", us: { text: "Masszírozó Hullámprofil", highlight: false }, them: "Sima / Forró" }
  ];

  return (
    <section className="py-12 md:py-16 px-3 md:px-4 bg-gray-50">
      <div className="max-w-4xl mx-auto">
        <h3 className="text-2xl md:text-4xl font-black text-center text-gray-900 mb-10 uppercase leading-tight">Miért nem ez egy átlagos <br/>&quot;hab&quot;</h3>
  ...
  return (
    <section className="py-12 px-4 bg-white border-t border-gray-200">
      <div className="max-w-4xl mx-auto bg-blue-50 border-4 border-blue-200 rounded-3xl p-5 md:p-10">
        <h3 className="text-2xl md:text-3xl font-black text-gray-900 mb-6 md:mb-8 flex items-center justify-center uppercase"><Package className="mr-3 w-8 h-8 md:w-10 md:h-10 text-blue-600" /> Mit kapsz haza</h3>
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-10">
            <div className="w-full md:w-1/2">
                <div className="aspect-square bg-white rounded-2xl shadow-lg border-2 border-gray-200 overflow-hidden relative">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-blue-900 text-white text-xs md:text-sm p-2 md:p-3 text-center font-bold uppercase">Higiénikusan vákuumcsomagolva</div>
                </div>
            </div>
            <div className="w-full md:w-1/2 text-left">
                <ul className="space-y-4 font-bold text-gray-900 text-lg md:text-xl">
                    ...
                    <li className="flex items-start bg-white p-4 rounded-xl shadow-sm border border-blue-100">
                        <span className="bg-blue-600 text-white rounded-full w-7 h-7 md:w-8 md:h-8 flex items-center justify-center text-sm md:text-lg mr-3 flex-shrink-0 font-black mt-0.5">✓</span>
                        <span className="leading-tight">1x Aloe Vera huzat cipzárral (már felhelyezve)</span>
                    </li>
                    <li className="flex items-start bg-white p-4 rounded-xl shadow-sm border border-blue-100">
                        <span className="bg-blue-600 text-white rounded-full w-7 h-7 md:w-8 md:h-8 flex items-center justify-center text-sm md:text-lg mr-3 flex-shrink-0 font-black mt-0.5">✓</span>
                        <span className="leading-tight">1x Vízálló matracvédő gumikkal</span>
                    </li>
                    <li className="flex items-start bg-white p-4 rounded-xl shadow-sm border border-blue-100">
                        <span className="bg-blue-600 text-white rounded-full w-7 h-7 md:w-8 md:h-8 flex items-center justify-center text-sm md:text-lg mr-3 flex-shrink-0 font-black mt-0.5">✓</span>
                ...
                <div className="mt-6 text-center md:text-left text-base md:text-lg text-blue-900 font-bold">
                    <span className="inline-block bg-blue-200 px-3 py-2 md:px-4 rounded-lg border border-blue-300 leading-tight">Ingyenes futárszállítás 24-48 órán belül</span>
                </div>
            </div>
        </div>
      </div>
...
const Reviews: React.FC = () => {
  const reviews: (Testimonial & { image?: string })[] = [
    { id: 1, name: "István K.", city: "Budapest", text: "Évek óta szenvedek isiásztól. A fizioterapeutám új matrac vásárlását javasolta, de túl drága volt. Ezzel a fedőmatraccal a problémám 90%-át megoldottam. Reggel le tudok hajolni fájdalom nélkül. Hihetetlen.", rating: 5 },
    { id: 2, name: "Katalin M.", city: "Debrecen", text: "Nyaki porckorongsérv van, ami ébredés után szédülést okozott. Amióta az Ortopéd Fedőmatracot használom, a nyakam sokkal lazább. A támogatás határozott, de kellemes.", rating: 5 },
    { id: 3, name: "László B.", city: "Szeged", text: "Raktárban dolgozom, és estére a hátam darabokban van. Ez a fedőmatrac szó szerint megfiatalít. Érzed, ahogy a gerinced megnyúlik, amikor lefekszel. Nagyon gyors szállítás.", rating: 5, image: "/images/ortopper-img/recensione-1.jpg" },
    { id: 4, name: "Mária N.", city: "Pécs", text: "Szkeptikus voltam a 'masszírozó' hatással kapcsolatban, de igaz. Keringési problémáim vannak a lábaimban, és sokkal kevésbé dagadtan ébredek. A hullámos felület átengedi a levegőt.", rating: 5 },
    { id: 5, name: "Dr. Ferenc T.", city: "Győr", text: "Az idős édesanyámnak vettem, aki sok időt tölt az ágyban. Kiváló a felfekvések és nyomási fájdalmak megelőzésére. Az anyag friss és higiénikus. Ajánlom.", rating: 5 },
    { id: 6, name: "Anna S.", city: "Miskolc", text: "A matracom egy nagy lyukká vált. Vesefájással ébredtem. 35.999 Ft-ért megúsztam egy 200.000 Ft-os kiadást. Most a gerincem egyenes, és 8 órát alszom megszakítás nélkül.", rating: 4 },
  ];
  ...
  return (
    <section className="py-12 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-gray-600 font-bold mb-10 md:mb-12 max-w-2xl mx-auto text-lg md:text-xl">Több ezer magyar abbahagyta a fájdalommal élést. Íme valós tapasztalataik.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {reviews.map((r) => (
                <div key={r.id} className="bg-gray-50 p-6 md:p-8 rounded-2xl border-2 border-gray-100 shadow-sm relative hover:shadow-lg transition-shadow flex flex-col">
                    ...
                    {r.image && (<div className="mb-4 rounded-xl overflow-hidden border-2 border-blue-100"><img src={r.image} alt="Ügyfél termékfotója" className="w-full h-48 object-cover" /></div>)}
        ...
        <div className="text-center mt-10 md:mt-12">
             <a href="#order-form" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-black text-xl md:text-2xl py-5 px-10 md:px-12 rounded-xl shadow-xl uppercase tracking-wide transform transition hover:scale-105">Csatlakozz a fájdalommentesen alvókhoz</a>
        </div>
      </div>
    </section>
  );
    ...
    <section id="order-form" className="py-12 px-4 bg-blue-50 border-t-4 border-blue-600">
      <div className="max-w-xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-300">
        <div className="bg-red-600 p-5 text-white text-center">
            ...
            <p className="text-sm md:text-base font-bold opacity-90 mt-1">Töltse ki az {PRICE} {CURRENCY}-os ár rögzítéséhez</p>
        </div>
        <div className="flex justify-between px-2 md:px-4 py-6 bg-gray-50 border-b border-gray-200 text-center">
             <div className="flex-1 px-1">
                ...
                <span className="text-xs md:text-sm font-bold text-gray-800 uppercase block leading-tight">Kitöltés</span>
             </div>
             <div className="flex-1 px-1 border-l border-gray-200">
                ...
                <span className="text-xs md:text-sm font-bold text-gray-500 uppercase block leading-tight">Megerősítés</span>
             </div>
             <div className="flex-1 px-1 border-l border-gray-200">
                ...
                <span className="text-xs md:text-sm font-bold text-gray-500 uppercase block leading-tight">Fizess átvételkor</span>
             </div>
        </div>
        <form onSubmit={handleSubmit} className="p-5 md:p-8 space-y-6">
            ...
            <div>
                ...
                <input required name="fullAddress" onChange={handleChange} type="text" placeholder="Pl. Kossuth utca 10, Budapest, 1054" className="w-full p-4 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none bg-gray-50 font-medium text-lg shadow-sm placeholder-gray-400" />
            </div>
            <div>
                ...
                <p className="text-xs text-gray-500 mt-2 font-medium">A futár erre a számra hív a szállítással kapcsolatban.</p>
            </div>
            ...
            <p className="text-center text-xs md:text-sm text-gray-500 font-semibold mt-4">A gombra kattintva megerősíti a vásárlást. Készpénzben fizet a futárnak.</p>
...
const FAQ: React.FC = () => {
  const faqs: FaqItem[] = [
    { question: "Porckorongsérv / isiász esetén segíthet?", answer: "Igen, kifejezetten gerincproblémákkal küzdők számára tervezték. A Memory Foam HD szerkezet felveszi a hát természetes görbületeit, csökkentve a porckorongokra nehezedő nyomást és enyhítve az isiász ideg gyulladását." },
    { question: "Miért kerül minden méret ugyanannyiba?", answer: "Semmi trükk. A raktár gyors felszabadítása és az új szállítmányok fogadása érdekében úgy döntöttünk, hogy az alapárat (Egyszemélyes) alkalmazzuk minden méretre, beleértve a Dupla és King méreteket is. Ez a vásárló előnye, amíg a készlet tart." },
    { question: "Túl puha? Félek, hogy besüllyedek.", answer: "Egyáltalán nem. Nagy sűrűségű Memory-t használunk, amely 'progresszív támogatást' nyújt. Felveszi a test formáját, de határozottan megtartja a súlyt, egyenesen tartva a gerincet. Ez nem egy hagyományos puha hab." },
    { question: "A nyakra is segít?", answer: "Természetesen. A gerinc helyes beállításával a válltól a medencéig, a nyaki szakasz is ellazulhat, csökkentve a nyaki feszültségeket és a reggeli fejfájásokat." },
    { question: "Nyáron izzasztó?", answer: "Nem. A 'hullámos' felület nem csak masszírozásra szolgál, hanem légcsatornákat hoz létre, amelyek elválasztják a testet az anyagtól. A levegő szabadon kering, elvezetve a nedvességet és a hőt." },
    { question: "Alkalmas a régi matracra?", answer: "Ez az ideális megoldás. A fedőmatrac korrigálja a régi matrac hibáit (lyukak, szúró rugók, kemény felület), visszaállítva az ortopéd alvófelületet új matrac vásárlása nélkül." },
    { question: "Fizethetek átvételkor?", answer: "Igen, ingyenes utánvétes fizetést kínálunk készpénzben, a maximális biztonság és nyugalom érdekében a vásárláskor." },
  ];
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans scroll-smooth text-gray-900 pb-24 md:pb-0">
      ...
      <img src="https://offers.uncappednetwork.com/forms/api/ck/?o=3043&uid=0191b25c-22d2-7f55-9d9b-79b67cebbff3&lp=3077" style={{width:'1px',height:'1px',display:'none'}} alt="" />
