...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && !alreadyTracked) {
      ...
      const ecValue = parseFloat(sessionStorage.getItem('ec_value') || '27999');
      ...
      script.onload = () => {
        ...
        if (ecAddress) userData.address = { street: ecAddress, country: 'HU' };
        if (Object.keys(userData).length > 0) window.gtag('set', 'user_data', userData);

        // Purchase HU conversion - UPDATE CONVERSION LABEL WHEN PROVIDED
        window.gtag('event', 'conversion', {
          'send_to': 'AW-17261661993/TITANSAW_HU_CONVERSION_LABEL',
          'value': ecValue,
          'currency': 'HUF',
    ...
    <div className="ty-container" style={{
      ...
      <div className="ty-box" style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.875rem', color: '#92400e', marginBottom: '0.25rem' }}>Rendelési szám</div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>Utánvételes fizetés</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Készpénzben fizet a futárnak</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Szállítás 24-48 órán belül</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>30 napos visszatérítés</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '0.25rem' }}>Segítségre van szüksége vagy visszaküldeni szeretné?</div>
          <a href="mailto:info@kizbuy.com" style={{ color: '#FF8C00', fontWeight: 600, textDecoration: 'none', fontSize: '0.95rem' }}>info@kizbuy.com</a>
          <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginTop: '0.5rem' }}>30 napon belül kérheti a visszatérítést, ha nem elégedett a termékkel</div>
        </div>
