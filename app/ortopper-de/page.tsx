    ...
    <section className="w-full bg-white pb-8 pt-2 px-3 md:px-4 border-b-8 border-blue-600 overflow-hidden">
      <div className="bg-yellow-300 text-center py-3 px-2 mb-6 -mx-3 md:-mx-4 shadow-sm border-b border-yellow-400">
        <p className="text-sm md:text-xl font-black text-red-700 uppercase tracking-wide animate-pulse leading-tight">
          ACHTUNG: Angebot "Gesunde Wirbelsaule" endet um Mitternacht
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-lg md:text-3xl font-bold text-gray-600 leading-snug max-w-5xl mx-auto px-2">
            Der einzige Topper mit <span className="text-blue-600 underline decoration-4 decoration-blue-200">Massagewellen</span>, der die Wirbelsäule dekomprimiert und Schmerzen während des Schlafs <span className="text-white bg-red-600 px-2 rounded-sm whitespace-nowrap">LINDERT</span>.
          </p>
        </div>
          ...
          <div className="space-y-4 px-1">
            ...
            <div className="flex items-start bg-blue-50 p-4 rounded-xl border border-blue-100 shadow-sm">
                ...
                <div>
                    ...
                    <p className="text-base text-gray-800 leading-snug mt-1">Die wellige Oberfläche reaktiviert die Durchblutung und reduziert <span className="font-bold text-red-600">nächtliches Kribbeln.</span></p>
                </div>
            </div>
            <div className="flex items-start bg-blue-50 p-4 rounded-xl border border-blue-100 shadow-sm">
                <CheckCircle2 className="w-8 h-8 text-blue-600 mr-4 flex-shrink-0 mt-1" />
            ...
            <div className="flex items-start bg-blue-50 p-4 rounded-xl border border-blue-100 shadow-sm">
                ...
                <div>
                    <h4 className="font-black text-gray-900 text-lg uppercase mb-1 leading-none">VOLLSTÄNDIGE STABILITÄT</h4>
            ...
            <div className="text-center mt-6 mb-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-3 text-left shadow-sm">
                    ...
                    <p className="text-xs text-gray-700 leading-tight">
                        Um Lagerplatz freizumachen, haben wir <strong>die Preise der großen Größen</strong> (King/Doppel) auf den Grundpreis des Einzelbetts gesenkt.
            ...
            <div className="w-1/2 space-y-4">
              ...
              <div className="flex items-start bg-blue-50 p-5 rounded-xl border border-blue-100 shadow-sm">
                  ...
                  <div>
                      ...
                      <p className="text-xl text-gray-800 leading-snug mt-1">Die wellige Oberfläche reaktiviert die Durchblutung und reduziert <span className="font-bold text-red-600">nächtliches Kribbeln.</span></p>
                  </div>
              </div>
              <div className="flex items-start bg-blue-50 p-5 rounded-xl border border-blue-100 shadow-sm">
                  <CheckCircle2 className="w-10 h-10 text-blue-600 mr-4 flex-shrink-0 mt-1" />
              ...
              <div className="flex items-start bg-blue-50 p-5 rounded-xl border border-blue-100 shadow-sm">
                  ...
                  <div>
                      <h4 className="font-black text-gray-900 text-2xl uppercase mb-1 leading-none">VOLLSTÄNDIGE STABILITÄT</h4>
            ...
            <div className="flex flex-row items-center justify-between gap-8 mt-4">
              <div className="flex-1">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-3 text-left shadow-sm max-w-md">
                    ...
                    <p className="text-sm text-gray-700 leading-tight">Um Lagerplatz freizumachen, haben wir <strong>die Preise der großen Größen gesenkt</strong>.<span className="text-red-600 font-bold"> Nutzen Sie es - zahlen Sie für klein, nehmen Sie groß!</span></p>
                </div>
              </div>
              <div className="flex-1">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:border-red-400 transition-colors">
                ...
                <h3 className="font-black text-xl text-gray-900 mb-2 uppercase">Lendenschmerzen</h3>
                <p className="text-base text-gray-700 font-medium leading-relaxed">Sie wachen mit schmerzenden unteren Rücken auf, weil die Matratze <span className="font-bold bg-yellow-100">die natürliche Krümmung nicht stützt.</span></p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:border-red-400 transition-colors">
                ...
                <h3 className="font-black text-xl text-gray-900 mb-2 uppercase">Nackensteifheit</h3>
                <p className="text-base text-gray-700 font-medium leading-relaxed">Steifer Nacken am Morgen? Das bedeutet, dass Schultern und Kopf <span className="font-bold bg-yellow-100">nicht ausgerichtet sind</span> während des Schlafs.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:border-red-400 transition-colors">
                ...
                <p className="text-base text-gray-700 font-medium leading-relaxed">Wachen Sie mit tauben Armen oder Beinen auf? Die Matratze <span className="font-bold bg-yellow-100">blockiert die Durchblutung.</span></p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:border-red-400 transition-colors">
        ...
        <div className="text-center mt-12 p-6 md:p-8 bg-blue-50 rounded-2xl border-2 border-blue-100 max-w-3xl mx-auto">
            <p className="text-xl md:text-3xl font-black text-blue-900 uppercase mb-3 leading-tight">DIE LÖSUNG IST KEINE MATRATZE FÜR 1000€</p>
            <p className="text-gray-800 text-lg md:text-xl font-medium">Sie brauchen eine korrigierende Unterstützung, die sich an Sie anpasst. <br className="hidden md:block"/><span className="font-bold text-blue-700 bg-white px-1">Der Orthopädische Topper</span> macht genau das.</p>
        </div>
      </div>
    </section>
  );
    ...
    <section className="bg-white py-12 md:py-16 px-4 border-t border-gray-200">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 uppercase mb-4 leading-tight">ORTHOPÄDISCHE <span className="text-blue-600">3-SCHICHTEN-TECHNOLOGIE</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-200 group hover:shadow-2xl transition-shadow flex flex-col">
                ...
                <div className="p-6 md:p-8 flex-1">
                    ...
                    <p className="text-gray-700 leading-relaxed text-lg md:text-xl font-medium">Das viskoelastische Material passt sich millimetergenau an den Körper an und füllt Hohlräume (Lendenbereich). Ermöglicht der Wirbelsäule, sich zu strecken, und den Bandscheiben, sich nachts <span className="bg-yellow-100 font-bold px-1 text-gray-900 border-b-2 border-yellow-300">zu hydratisieren</span>.</p>
                </div>
            </div>
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-200 group hover:shadow-2xl transition-shadow flex flex-col">
                <div className="aspect-square w-full relative">
                ...
                <div className="p-6 md:p-8 flex-1">
                    ...
                    <p className="text-gray-700 leading-relaxed text-lg md:text-xl font-medium">Die spezielle wellige Bearbeitung übt bei jeder Bewegung eine <span className="bg-yellow-100 font-bold px-1 text-gray-900 border-b-2 border-yellow-300">passive Mikromassage</span> aus. Stimuliert die Kapillardurchblutung und reduziert Schwellungen und Wassereinlagerungen.</p>
                </div>
            </div>
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-200 group hover:shadow-2xl transition-shadow flex flex-col">
                <div className="aspect-square w-full relative">
                ...
                <div className="p-6 md:p-8 flex-1">
                    ...
                    <p className="text-gray-700 leading-relaxed text-lg md:text-xl font-medium">Durch gleichmäßige Gewichtsverteilung auf <span className="bg-yellow-100 font-bold px-1 text-gray-900 border-b-2 border-yellow-300">7 CM Dicke</span> eliminiert er Druckspitzen an Hüften und Schultern. Entscheidend für Menschen mit Gelenkschmerzen und Kribbeln.</p>
                </div>
            </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="bg-blue-800 p-6 md:p-8 rounded-3xl border-2 border-blue-700 flex items-start hover:bg-blue-700 transition-colors shadow-lg">
                ...
                <div>
                    ...
                    <p className="text-blue-50 font-medium text-lg md:text-xl leading-snug">Ob Sie auf dem Rücken oder der Seite schlafen, der Topper hält die natürliche Achse. Sie wachen gerade auf, ohne die Wirbelsäule "knacken" zu müssen.</p>
                </div>
            </div>
            <div className="bg-blue-800 p-6 md:p-8 rounded-3xl border-2 border-blue-700 flex items-start hover:bg-blue-700 transition-colors shadow-lg">
            ...
            <div className="bg-blue-800 p-6 md:p-8 rounded-3xl border-2 border-blue-700 flex items-start hover:bg-blue-700 transition-colors shadow-lg">
                ...
                <div>
                    <h4 className="font-black text-xl md:text-2xl text-white mb-2 uppercase">Vollständige Stabilität</h4>
            ...
            <div className="bg-blue-800 p-6 md:p-8 rounded-3xl border-2 border-blue-700 flex items-start hover:bg-blue-700 transition-colors shadow-lg">
                ...
                <div>
                    ...
                    <p className="text-blue-50 font-medium text-lg md:text-xl leading-snug">Aloe Vera Bezug mit Reißverschluss zum schnellen Waschen. Antimilben- und hypoallergene Materialien, ideal für empfindliche Personen.</p>
                </div>
            </div>
        </div>
        <div className="text-center mt-12">
             <a href="#order-form" className="inline-block bg-green-500 hover:bg-green-600 text-white font-black text-xl md:text-3xl py-5 px-10 md:py-6 md:px-16 rounded-full shadow-2xl border-b-8 border-green-700 transform transition hover:scale-105 uppercase tracking-wide">JETZT LINDERUNG SPÜREN</a>
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-start gap-10">
            <div className="flex flex-col items-center flex-1">
                ...
                <p className="text-lg text-gray-600 font-medium leading-snug">Öffnen Sie die Vakuumverpackung und legen Sie ihn bequem auf die alte Matratze.</p>
            </div>
        ...
        <div className="mt-12 bg-yellow-50 inline-block px-6 py-4 rounded-xl border-2 border-yellow-200 text-base md:text-lg text-yellow-900 font-bold max-w-3xl">
            Hinweis: Wird <span className="font-black uppercase">vakuumverpackt</span> geliefert. Wir empfehlen, 24-48 Stunden auf die volle Ausdehnung (7cm) zu warten, aber Sie können ihn bereits nach 4 Stunden benutzen.
        </div>
      </div>
    </section>
  );
...
const Comparison: React.FC = () => {
  const features = [
    { name: "Innenstruktur", us: { text: "DOPPELSCHICHT (Memory+HR)", highlight: true }, them: "Einzelne Schicht" },
    { name: "Gesamtdicke", us: { text: "7 CM TATSÄCHLICH", highlight: true }, them: "Nur 3-4 CM" },
    { name: "Art der Unterstützung", us: { text: "Aktiv Orthopädisch", highlight: false }, them: "Passiv / Weich" },
    { name: "Auswirkung auf Wirbelsäule", us: { text: "Dekompression", highlight: false }, them: "Einsinken" },
  ...
  return (
    <section className="py-12 md:py-16 px-3 md:px-4 bg-gray-50">
      <div className="max-w-4xl mx-auto">
        <h3 className="text-2xl md:text-4xl font-black text-center text-gray-900 mb-10 uppercase leading-tight">Warum dies kein gewöhnlicher <br/>"Schaumstoff" ist</h3>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-10">
            ...
            <div className="w-full md:w-1/2 text-left">
                <ul className="space-y-4 font-bold text-gray-900 text-lg md:text-xl">
                    ...
                    <li className="flex items-start bg-white p-4 rounded-xl shadow-sm border border-blue-100">
                        <span className="bg-blue-600 text-white rounded-full w-7 h-7 md:w-8 md:h-8 flex items-center justify-center text-sm md:text-lg mr-3 flex-shrink-0 font-black mt-0.5">&#10003;</span>
                        <span className="text-blue-800 uppercase leading-tight">Offizielle 2 Jahre Garantie</span>
                    </li>
                </ul>
                <div className="mt-6 text-center md:text-left text-base md:text-lg text-blue-900 font-bold">
                    <span className="inline-block bg-blue-200 px-3 py-2 md:px-4 rounded-lg border border-blue-300 leading-tight">Kostenloser Kurierversand 24-48h</span>
                </div>
            </div>
        </div>
      </div>
...
const Reviews: React.FC = () => {
  const reviews: (Testimonial & { image?: string })[] = [
    { id: 1, name: "Thomas K.", city: "Berlin", text: "Seit Jahren leide ich unter Ischias. Mein Physiotherapeut empfahl einen Matratzenwechsel, aber der war zu teuer. Mit diesem Topper habe ich 90% des Problems gelöst. Morgens kann ich mich ohne Schmerzen bücken. Unglaublich.", rating: 5 },
    { id: 2, name: "Maria S.", city: "München", text: "Ich habe einen Bandscheibenvorfall im Nackenbereich, der nach dem Aufwachen Schwindel verursachte. Seit ich den Orthopädischen Topper benutze, ist mein Nacken viel entspannter. Die Unterstützung ist fest, aber angenehm.", rating: 5 },
    { id: 3, name: "Hans B.", city: "Hamburg", text: "Ich arbeite im Lager und abends ist mein Rücken kaputt. Dieser Topper verjüngt mich buchstäblich. Man spürt, wie sich die Wirbelsäule streckt, wenn man sich hinlegt. Sehr schnelle Lieferung.", rating: 5, image: "/images/ortopper-img/recensione-1.jpg" },
    { id: 4, name: "Petra M.", city: "Frankfurt", text: "Ich war skeptisch gegenüber dem 'Massage'-Effekt, aber es stimmt. Ich habe Durchblutungsprobleme in den Beinen und wache viel weniger geschwollen auf. Die wellige Oberfläche lässt Luft durch.", rating: 5 },
    { id: 5, name: "Dr. Stefan N.", city: "Köln", text: "Ich habe ihn für meine ältere Mutter gekauft, die viel Zeit im Bett verbringt. Hervorragend zur Vorbeugung von Druckstellen und Druckschmerzen. Der Stoff ist frisch und hygienisch. Empfehle ich.", rating: 5 },
    { id: 6, name: "Barbara W.", city: "Stuttgart", text: "Meine Matratze war ein einziges Loch geworden. Ich wachte mit Nierenschmerzen auf. Für 89€ habe ich mir 500€ Ausgaben gespart. Jetzt ist meine Wirbelsäule gerade und ich schlafe 8 Stunden durch.", rating: 4 },
  ];

  return (
    <section className="py-12 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        <h3 className="text-3xl md:text-4xl font-black text-center text-gray-900 mb-4 uppercase leading-tight">Geschichten täglicher Genesung</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {reviews.map((r) => (
                <div key={r.id} className="bg-gray-50 p-6 md:p-8 rounded-2xl border-2 border-gray-100 shadow-sm relative hover:shadow-lg transition-shadow flex flex-col">
                    ...
                    {r.image && (<div className="mb-4 rounded-xl overflow-hidden border-2 border-blue-100"><img src={r.image} alt="Kundenproduktfoto" className="w-full h-48 object-cover" /></div>)}
...
const OrderForm: React.FC<OrderFormProps> = ({ selectedSize, onSelectSize }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to German TY page
      window.location.href = '/ty-de';
    } catch (error) {
      ...
      <div className="max-w-xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-300">
        ...
        <div className="flex justify-between px-2 md:px-4 py-6 bg-gray-50 border-b border-gray-200 text-center">
             ...
             <div className="flex-1 px-1 border-l border-gray-200">
                ...
                <span className="text-xs md:text-sm font-bold text-gray-500 uppercase block leading-tight">Beim Kurier bezahlen</span>
             </div>
        </div>
        <form onSubmit={handleSubmit} className="p-5 md:p-8 space-y-6">
            ...
            <div>
                ...
                <p className="text-xs text-gray-500 mt-2 font-medium">Der Kurier wird diese Nummer für die Lieferung anrufen.</p>
            </div>
            ...
            <p className="text-center text-xs md:text-sm text-gray-500 font-semibold mt-4">Mit dem Klick bestätigen Sie den Kauf. Sie bezahlen bar beim Kurier.</p>
            <div className="flex justify-center gap-2 md:gap-4 pt-6 border-t border-gray-100 flex-wrap">
                ...
                <div className="flex items-center text-xs md:text-sm text-gray-600 font-bold"><Lock className="w-4 h-4 md:w-5 md:h-5 mr-1 text-gray-600"/> Keine Karte</div>
            </div>
        </form>
      </div>
    </section>
...
const FAQ: React.FC = () => {
  const faqs: FaqItem[] = [
    { question: "Ich habe einen Bandscheibenvorfall / Ischias, kann er mir helfen?", answer: "Ja, er wurde speziell für Menschen mit Wirbelsäulenproblemen entwickelt. Die Memory Foam HD Struktur nimmt die natürlichen Krümmungen des Rückens auf, reduziert den Druck auf die Bandscheiben und lindert Ischiasnerventzündungen." },
    { question: "Warum kosten alle Größen gleich?", answer: "Kein Haken. Um schnell Lagerplatz freizumachen und Platz für neue Lieferungen zu schaffen, haben wir beschlossen, den Grundpreis (Einzelbett) für alle Größen anzuwenden, einschließlich Doppelbett und King Size. Das ist ein Vorteil für den Kunden, solange der Vorrat reicht." },
    { question: "Ist er zu weich? Ich habe Angst einzusinken.", answer: "Absolut nicht. Wir verwenden hochdichtes Memory, das 'progressive Unterstützung' bietet. Es nimmt den Körper auf, stützt aber das Gewicht entschieden und hält die Wirbelsäule gerade. Das ist kein gewöhnlicher weicher Schaumstoff." },
    { question: "Hilft er auch beim Nacken?", answer: "Natürlich. Durch die korrekte Ausrichtung der Wirbelsäule von den Schultern bis zum Becken kann sich auch der Halsbereich entspannen, was Nackenverspannungen und morgendliche Kopfschmerzen reduziert." },
    { question: "Verursacht er Schwitzen im Sommer?", answer: "Nein. Die 'wellige' Oberfläche dient nicht nur der Massage, sondern schafft Luftkanäle, die den Körper vom Material trennen. Die Luft zirkuliert frei und transportiert Feuchtigkeit und Wärme ab." },
    { question: "Ist er für meine alte Matratze geeignet?", answer: "Das ist die ideale Lösung. Der Topper korrigiert die Mängel einer alten Matratze (Löcher, stechende Federn, harte Oberfläche) und stellt einen orthopädischen Schlafplatz wieder her, ohne eine neue Matratze kaufen zu müssen." },
    { question: "Kann ich bei Lieferung bezahlen?", answer: "Ja, wir bieten kostenlose Nachnahmezahlung (bar bei Lieferung) an, um maximale Sicherheit und Ruhe beim Kauf zu gewährleisten." },
  ];
      ...
      <div className="flex items-center gap-2">
        <div className="flex-1 pl-1">
          <div className="text-[10px] text-red-600 font-black uppercase flex items-center mb-0.5 animate-pulse">
            ⏰ LÄUFT AB IN: {formatTime(timeLeft)}
          </div>
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans scroll-smooth text-gray-900 pb-24 md:pb-0">
      ...
      <img src="https://offers.uncappednetwork.com/forms/api/ck/?o=3040&uid=0191b25c-22d2-7f55-9d9b-79b67cebbff3&lp=3074" style={{width:'1px',height:'1px',display:'none'}} alt="" />
