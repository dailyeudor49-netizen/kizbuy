    ...
    if (typeof window !== 'undefined' && !alreadyTracked) {
      ...
      script.onload = () => {
        ...
        window.gtag('event', 'conversion', {
          'send_to': 'AW-17930736121/WJwvCKaXo_sbEPmjheZC',
          'value': ecValue,
          'currency': 'HUF',
    ...
    <div className="ty-container" style={{
      ...
      <div className="ty-box" style={{
        ...
        <p style={{
          ...
          Rendelése sikeresen beérkezett.
        </p>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Kézbesítés 24-48 órán belül</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '0.25rem' }}>Segítségre van szüksége vagy visszatérítést szeretne?</div>
          <a href="mailto:info@kizbuy.com" style={{ color: '#FF8C00', fontWeight: 600, textDecoration: 'none', fontSize: '0.95rem' }}>info@kizbuy.com</a>
          <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginTop: '0.5rem' }}>30 napon belül visszatérítést kérhet, ha nem elégedett a termékkel</div>
        </div>
