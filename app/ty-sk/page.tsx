      ...
      <div className="ty-box" style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>Platba pri doručení</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Zaplatíte hotovosťou kuriérovi</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>Doprava zadarmo</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Doručenie do 24-48 hodín</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Vrátenie peňazí, ak nie ste spokojní</div>
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '0.25rem' }}>Potrebujete pomoc alebo chcete požiadať o vrátenie?</div>
          <a href="mailto:info@kizbuy.com" style={{ color: '#FF8C00', fontWeight: 600, textDecoration: 'none', fontSize: '0.95rem' }}>info@kizbuy.com</a>
          <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginTop: '0.5rem' }}>Môžete požiadať o vrátenie do 30 dní, ak nie ste s produktom spokojní</div>
        </div>
