...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans scroll-smooth text-gray-900 pb-24 md:pb-0">
      ...
      <img src="https://offers.uncappednetwork.com/forms/api/ck/?o=3042&uid=0191b25c-22d2-7f55-9d9b-79b67cebbff3&lp=3076" style={{width:'1px',height:'1px',display:'none'}} alt="" />
