                   ...
                   <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-gray-100 relative bg-white">
                       ...
                       <div className="absolute top-3 right-3 z-10">
                          <div className="bg-red-600 text-white border-2 border-white rounded-xl shadow-lg p-2 md:p-2.5 transform rotate-[3deg] flex flex-col items-center">
                             ...
                             <span className="text-[8px] md:text-[10px] font-bold uppercase leading-none text-white tracking-wider">KIT ACCESSORI</span>
                             <span className="text-sm md:text-base font-black uppercase leading-none text-yellow-300 drop-shadow-md">GRATIS</span>
                             <span className="text-[8px] md:text-[9px] uppercase font-black bg-white text-red-600 px-1.5 py-0.5 rounded">€100</span>
                          </div>
                       </div>
