    ...
    <div className="pb-24 md:pb-0 bg-white min-h-screen font-sans text-gray-900 overflow-x-hidden">
               ...
               <div className="relative mx-auto max-w-[500px] md:max-w-full md:sticky md:top-24">
                   ...
                   <div className="absolute -bottom-6 -right-2 z-20">
                      <div className="bg-red-600 text-white border-[3px] border-white rounded-2xl shadow-[0_10px_20px_rgba(0,0,0,0.3)] p-3 md:p-5 transform rotate-[-6deg] flex flex-col items-center hover:scale-110 transition-transform duration-300">
                         ...
                         <span className="text-xs md:text-sm font-bold uppercase leading-none text-white tracking-wider">KIT ACCESSORI</span>
                         <span className="text-2xl md:text-3xl font-black uppercase leading-none text-yellow-300 my-1 drop-shadow-md">GRATIS</span>
                         <span className="text-xs uppercase font-black bg-white text-red-600 px-2 py-0.5 rounded shadow-sm">Valore €100</span>
                      </div>
                   </div>
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 text-center text-xs pb-40">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-500 text-xs mb-6">LithiumPro™ è un marchio registrato e distribuito da <a href="https://kizbuy.com" className="text-green-500 hover:text-green-400 font-bold">Kizbuy</a></p>
          <div className="flex flex-wrap justify-center gap-6 mb-6 font-bold uppercase text-[10px] tracking-widest text-gray-500">
            ...
            <span className="cursor-pointer hover:text-white">Termini di Vendita</span>
            <a href="mailto:info@kizbuy.com" className="cursor-pointer hover:text-white">Contattaci</a>
          </div>
          <p className="opacity-60 max-w-xs mx-auto leading-relaxed">
             &copy; 2025 Kizbuy - LithiumPro Tools.<br/>Tutti i diritti riservati.
          </p>
        </div>
      </footer>
