...
const comparisonData = [
    ...
    },
    {
        ...
        us: { text: "ÁNO, AJ 10-ROČNÝCH", sub: "Potrebujete len HDMI", highlight: false },
        them: { text: "Nie", sub: "Musíte kúpiť nový", highlight: false }
    },
    {
        feature: "Inštalácia",
        us: { text: "30 Sekúnd", sub: "Urobíte to sami", highlight: false },
        them: { text: "Komplikovaná", sub: "Účty, WiFi, Kanály...", highlight: false }
    },
    {
        feature: "Mobilita",
        us: { text: "ÁNO, VŠADE", sub: "Dovolenka, Hotel, Chata", highlight: false },
        them: { text: "NIE", sub: "Zostáva na mieste", highlight: false }
    },
    {
        feature: "Videohry?",
        us: { text: "V BALENÍ", sub: "+ Ovládač Zadarmo", highlight: true },
        them: { text: "ZVLÁŠŤ", sub: "Potrebujete konzolu", highlight: false }
    },
    {
        feature: "Životnosť",
        us: { text: "NA ROKY", sub: "Aktualizujete len box", highlight: false },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="hidden md:block overflow-hidden rounded-xl border-2 border-gray-200 shadow-2xl">
          <table className="w-full text-center border-collapse">
            <thead>
              <tr>
                <th className="p-4 bg-gray-50 w-1/3 text-gray-500 font-bold uppercase text-sm tracking-wider">Vlastnosť</th>
        ...
        <div className="md:hidden space-y-6">
            ...
            <div className="text-center mt-6">
                <p className="text-sm text-gray-500 italic">
                    Výsledok: Box vyhráva 6:0 v pomere cena/kvalita.
                </p>
            </div>
        </div>
