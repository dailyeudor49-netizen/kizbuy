    ...
    <section className="py-12 bg-white">
      <div className="max-w-5xl mx-auto px-4">
        <h2 className="text-3xl font-black text-center mb-10 uppercase text-gray-900 leading-tight">
          ...
          <span className="text-green-600">AKO DETSKÁ HRA</span>
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">ZAPOJTE</h3>
            <p className="text-gray-600 px-4">
              Pripojte HDMI kábel k televízoru. Nemusíte volať technika, jednoducho nájdite voľný port vzadu na TV.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">PRIPOJTE</h3>
            <p className="text-gray-600 px-4">
              Zapnite zariadenie a pripojte ho k domácej WiFi (alebo k internetu z mobilu). Funguje so všetkými operátormi.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">POZERAJTE</h3>
            <p className="text-gray-600 px-4">
              Hotovo! Máte prístup k tisíckam kanálov, filmov, seriálov a hier. Bez zmlúv a bez stresu.
            </p>
          </div>
