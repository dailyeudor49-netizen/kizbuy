        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-red-500 text-center">
            ...
            <p className="text-gray-600 leading-relaxed">
              Unavilo vás zasekávanie zápasov a "pixelovaná" obrazovka? Starý dekodér nepodporuje <span className="font-bold text-gray-800">Skutočné 4K</span>, ktoré si zaslúžite.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-red-500 text-center">
            ...
            <p className="text-gray-600 leading-relaxed">
              Bežná televízia je minulosťou. Ak chcete sledovať najnovšie filmy a seriály, musíte platiť <span className="font-bold text-gray-800">stovky eur</span> mesačne za predplatné.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-red-500 text-center">
            ...
            <p className="text-gray-600 leading-relaxed">
              Deti chcú hrať <span className="font-bold text-gray-800">Fortnite alebo FIFA</span>, ale míňať 500+ {CURRENCY} na konzolu je šialenstvo?
            </p>
          </div>
        </div>
