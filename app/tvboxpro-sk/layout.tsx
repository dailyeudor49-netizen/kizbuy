...
export const metadata = {
  title: 'TV Box 4K: Kino, Šport a Hry v jednom zariadení',
  description: 'Prvý "Všetko v jednom" Box, ktorý prináša filmy, živý šport a hry na akýkoľvek televízor.',
};

export default function TvboxproSkLayout({
  children,
}: {
